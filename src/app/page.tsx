...
const Page = () => {
    ...
    return (
        <div
            ...
            <div
                key={"header"}
                className={'fixed top-0 left-0 flex  w-full z-50 items-center justify-start px-[5.21vw] py-[3.70vh]'}>
                    ...
                    <nav className="flex gap-[60px] transition-colors duration-300 font-bold">
                        {NAV_ITEMS.map(({id, label}) => (
                            <button
                                ...
                                className={[
                                    "cursor-pointer transition-colors duration-300 text-[1.25vw]",
                                    getNavTextColor(id),
                                ].join(" ")}
                            >
                                {label}
            ...
            <div
                id={"about"}
                className={`flex flex-col min-h-screen bg-white items-center`}>
                <AboutLayout/>
            </div>
