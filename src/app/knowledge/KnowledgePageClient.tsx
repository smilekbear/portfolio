                    ...
                    {(() => {
                        ...
                        return data.map((item, index) => (
                            <div key={item.id ?? index}>
                                ...
                                {index !== data.length - 1 && <div className="my-6 h-px w-full bg-gray-200" />}
                            </div>
                        ));
                    })()}
                </div>

                <PaginationComponent page={page} totalPage={handleCalculateTotalPage()} />
            </div>
